          ...
          <div className="w-full space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="mt-4 p-4 rounded-2xl bg-white/50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5">
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <a
                  href="#embed-badge"
                  className="h-10 px-3.5 rounded-xl bg-teal-500/10 hover:bg-teal-500/20 border border-teal-500/20 flex items-center gap-1.5 text-teal-600 dark:text-teal-400 font-bold text-xs transition-all hover:scale-105"
                  title="Get Embeddable Audit Badge"
                >
                  <Code2 size={14} />
