                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-16">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <a href="https://www.linkedin.com/in/alfaz-mahmud-rizve/" target="_blank" className="text-slate-400 dark:text-slate-500 hover:text-teal-600 dark:hover:text-blue-400 transition-colors" title="LinkedIn">
                            ...
                            <a href="https://www.youtube.com/@whoisalfazz" target="_blank" className="text-slate-400 dark:text-slate-500 hover:text-teal-600 dark:hover:text-blue-400 transition-colors" title="YouTube">
                            ...
                            <a href="https://www.instagram.com/whois.alfaz/" target="_blank" className="text-slate-400 dark:text-slate-500 hover:text-teal-600 dark:hover:text-blue-400 transition-colors" title="Instagram">
                            ...
                            <a href="https://facebook.com/alfazmahmudrizve" target="_blank" className="text-slate-400 dark:text-slate-500 hover:text-teal-600 dark:hover:text-blue-400 transition-colors" title="Facebook">
