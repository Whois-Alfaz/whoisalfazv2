            ...
            <div className="max-w-6xl mx-auto px-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-slate-500">
                            <li><Link href="/blog" className="hover:text-blue-400 transition-colors">Insights (Blog)</Link></li>
                            <li><Link href="/portfolio" className="hover:text-blue-400 transition-colors">Portfolio</Link></li>
                            <li><Link href="/partners" className="hover:text-blue-400 transition-colors">Partner Network</Link></li>
                            <li><Link href="/contact" className="hover:text-blue-400 transition-colors">Strategy Call</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <a href="https://www.linkedin.com/in/alfaz-mahmud-rizve/" target="_blank" className="text-slate-500 hover:text-blue-400 transition-colors" title="LinkedIn">
                            ...
                            <a href="https://www.youtube.com/@whoisalfazz" target="_blank" className="text-slate-500 hover:text-blue-400 transition-colors" title="YouTube">
                            ...
                            <a href="https://www.instagram.com/whois.alfaz/" target="_blank" className="text-slate-500 hover:text-blue-400 transition-colors" title="Instagram">
                            ...
                            <a href="https://www.facebook.com/" target="_blank" className="text-slate-500 hover:text-blue-400 transition-colors" title="Facebook">
                            ...
                            <a href="mailto:contact@whoisalfaz.me" className="text-slate-500 hover:text-blue-400 transition-colors" title="Email Me">
                ...
                <div className="border-t border-slate-800/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-600 text-[10px] uppercase tracking-widest font-mono">
                    <p>&copy; {currentYear} WhoIsAlfaz. Built with Next.js & MDX.</p>
