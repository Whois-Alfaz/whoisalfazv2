...
description: >-
  ...
  source, and language. Save hours using a real workflow by Alfaz Mahmud Rizve.
date: '2026-03-04'
seoTitle: >-
  Lead Scoring Automation with n8n & Brevo (Free Template)
seoDescription: >-
  Learn how to automate lead scoring using n8n and the Brevo API. Instantly route and tag WordPress Elementor leads by intent, source, and language.
...
**Execute the Test**: Submit a test lead through your live form (e.g., Email: `test@agency.com`, Intent: `demo`, Source: `linkedin`, Language: `es`).
