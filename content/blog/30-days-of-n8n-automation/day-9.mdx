---
title: >-
  Lead Scoring Automation: Auto-tag Leads in Brevo & Trigger LinkedIn Outreach
  via HeyReach (Intent, Source, Language) – 30 Days of n8n & Automation – Day 9
...
description: >-
  ...
  source, and language — then automatically trigger LinkedIn outreach via
  HeyReach for high-intent prospects. Save hours using a real multi-channel
  workflow by Alfaz Mahmud Rizve.
date: '2026-03-04'
seoTitle: >-
  Lead Scoring Automation with n8n, Brevo & HeyReach (Free Multi-Channel Template)
seoDescription: >-
  Learn how to automate lead scoring using n8n, the Brevo API, and HeyReach.
  Instantly route and tag Elementor leads by intent, source, and language — then
  automatically trigger personalized LinkedIn connection requests for your
  highest-value B2B prospects.
